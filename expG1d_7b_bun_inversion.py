"""expG1d: 7B Blind Inverted-F — The Bun Inversion at Scale

Replicates G1b/G1c on Qwen2.5-7B (28 layers, d=3584, tied embeddings).
...
def main():
    ...
    print(f"\n{'='*70}")
    print(f"  7B BUN INVERSION — COMPLETE in {elapsed:.1f}s")
    print(f"{'='*70}\n")
    ...
    out_path = OUTPUT_DIR / "expG1d_7b_bun_inversion.json"
